...
export const fastModePhrases: Record<"street" | "neutral" | "formal", Phrase[]> = {
  street: [
    { spanish: "Mesa para dos, porfa.", english: "Table for two.", pronunciation: "MEH-sah PAH-rah dohs, POR-fah" },
    { spanish: "Una chela, porfa.", english: "A beer, please.", pronunciation: "OO-nah CHEH-lah, POR-fah" },
    { spanish: "Esto, porfa.", english: "This one. (point)", pronunciation: "EHS-toh, POR-fah" },
    { spanish: "La cuenta, porfa.", english: "The check.", pronunciation: "lah KWEHN-tah, POR-fah" },
    { spanish: "Mas agua, porfa.", english: "More water.", pronunciation: "mahs AH-gwah, POR-fah" },
    { spanish: "Sin picante.", english: "No spice.", pronunciation: "seen pee-KAHN-teh" },
    { spanish: "Donde esta el bano?", english: "Bathroom?", pronunciation: "DOHN-deh ehs-TAH el BAH-nyoh" },
  ...
  formal: [
    ...
    { spanish: "Este, por favor.", english: "This one, please.", pronunciation: "EHS-teh, por fah-VOR" },
    ...
    { spanish: "Nos podria traer mas agua, por favor?", english: "More water, please?", pronunciation: "nohs poh-DREE-ah trah-EHR mahs AH-gwah, por fah-VOR" },
    { spanish: "Sin picante, por favor.", english: "No spice, please.", pronunciation: "seen pee-KAHN-teh, por fah-VOR" },
    { spanish: "Donde esta el bano, por favor?", english: "Where is the bathroom?", pronunciation: "DOHN-deh ehs-TAH el BAH-nyoh, por fah-VOR" },
    { spanish: "Muchas gracias.", english: "Thank you very much.", pronunciation: "MOO-chahs GRAH-see-ahs" },
  ],
}
    ...
    flowStages: [
      ...
      },
      {
        ...
        primaryPhrasesByTone: {
          street: [
            { spanish: "Una chela, porfa.", english: "A beer, please.", pronunciation: "OO-nah CHEH-lah, POR-fah" },
            { spanish: "Dos chelas, porfa.", english: "Two beers, please.", pronunciation: "dohs CHEH-lahs, POR-fah", variables: [{ label: "Cantidad", placeholder: "Dos", options: ["Una", "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Siete", "Ocho"] }] },
            { spanish: "Una michelada, porfa.", english: "A michelada, please.", pronunciation: "OO-nah mee-cheh-LAH-dah, POR-fah" },
            { spanish: "Un mezcalito.", english: "A mezcal.", pronunciation: "oon mehs-kah-LEE-toh" },
            { spanish: "Otra igual.", english: "Another of the same.", pronunciation: "OH-trah ee-GWAHL" },
            { spanish: "La misma.", english: "The same one.", pronunciation: "lah MEES-mah" },
            { spanish: "Otra ronda, porfa.", english: "Another round, please.", pronunciation: "OH-trah ROHN-dah, POR-fah" },
            { spanish: "Que cerveza tienen?", english: "What beer do you have?", pronunciation: "keh ser-VEH-sah tee-EH-nen" },
            { spanish: "Agua mineral, porfa.", english: "Sparkling water, please.", pronunciation: "AH-gwah mee-neh-RAHL, POR-fah" },
            { spanish: "Agua natural, porfa.", english: "Still water, please.", pronunciation: "AH-gwah nah-too-RAHL, POR-fah" },
          ],
          neutral: [
      ...
      },
      {
        ...
        primaryPhrasesByTone: {
          street: [
            { spanish: "La cuenta, porfa.", english: "The check, please.", pronunciation: "lah KWEHN-tah, POR-fah" },
            ...
            { spanish: "Para llevar, porfa.", english: "To go box, please.", pronunciation: "PAH-rah yeh-VAR, POR-fah" },
          ],
          neutral: [
            { spanish: "La cuenta, por favor.", english: "The check, please.", pronunciation: "lah KWEHN-tah, por fah-VOR" },
